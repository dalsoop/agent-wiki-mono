...
public struct FileSystemService {
    ...
    public func enumerateDirectory(at url: URL, includingHidden: Bool = false) throws -> [FileEntry] {
    ...
    /// (especially ones tagged via Finder label index, or
    ...
    public static func tagColors(for url: URL, names: [String], primaryLabelNumber: Int = 0) -> [Int] {
    ...
    /// and Spotlight render the same string FileBrowserKit wrote. `label == 0`
    ...
    public static func ancestorFolders(from root: URL, to leaf: URL) -> [URL] {
    ...
    public static func folderHasCustomIcon(at url: URL) -> Bool {
