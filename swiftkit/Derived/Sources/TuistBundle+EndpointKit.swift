...
/// Since EndpointKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "swiftkit_EndpointKit"
        ...
        fatalError("unable to find bundle named swiftkit_EndpointKit")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class EndpointKitResources: NSObject {
