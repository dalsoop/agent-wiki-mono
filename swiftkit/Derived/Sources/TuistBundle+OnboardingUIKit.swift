...
/// Since OnboardingUIKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "swiftkit_OnboardingUIKit"
        ...
        fatalError("unable to find bundle named swiftkit_OnboardingUIKit")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class OnboardingUIKitResources: NSObject {
