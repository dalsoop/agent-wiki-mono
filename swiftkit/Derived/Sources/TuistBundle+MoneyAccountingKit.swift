...
/// Since MoneyAccountingKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "swiftkit_MoneyAccountingKit"
        ...
        fatalError("unable to find bundle named swiftkit_MoneyAccountingKit")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class MoneyAccountingKitResources: NSObject {
