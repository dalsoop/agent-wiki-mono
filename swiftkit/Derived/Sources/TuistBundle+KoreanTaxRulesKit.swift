...
/// Since KoreanTaxRulesKit is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "swiftkit_KoreanTaxRulesKit"
        ...
        fatalError("unable to find bundle named swiftkit_KoreanTaxRulesKit")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public final class KoreanTaxRulesKitResources: NSObject {
