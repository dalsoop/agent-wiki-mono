...
let project = Project.dualEntryApp(
    ...
    guiName: "AgentWikiStudio",
    cliName: "agent-wiki-studio",
    coreDependencies: [
    ...
    guiResources: [
        ...
        "Sources/AgentWikiStudio/Localization/Resources/**"
    ],
    infoPlist: .file(path: "Packaging/Info.plist"),
    entitlements: .file(path: "Packaging/AgentWikiStudio.entitlements")
)
